  ...
  requests: [
    {
      ...
      quote_considerations: ["eco_products_preferred", "include_initial_deep_clean"],
    ...
    },
    {
      ...
      quote_considerations: ["include_initial_deep_clean", "parking_permit_needed"],
      scope_confidence: "medium",
    ...
    },
    {
      ...
      quote_considerations: ["access_to_confirm", "oven_windows_to_confirm"],
